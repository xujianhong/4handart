 ...
 */
@ActivityScope
class ModifyMottoPresenter
@Inject
constructor(model: ModifyMottoContract.Model, rootView: ModifyMottoContract.View) :
    BasePresenter<ModifyMottoContract.Model, ModifyMottoContract.View>(model, rootView) {
    @Inject
    ...
    fun updateCustomer(motto:String){
        mModel.updateCustomer(mSessionId,null,null,null,null,null,motto)

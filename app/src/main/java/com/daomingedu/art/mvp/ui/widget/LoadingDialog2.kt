 ...
 * version 1.0
 */
class LoadingDialog2(context: Context, theme: Int=R.style.LoadingDialog, tips:String="加载中...") : Dialog(context, theme) {

    init {
        val contentView = LayoutInflater.from(context).inflate(R.layout.dialog_loading_progress2, null)

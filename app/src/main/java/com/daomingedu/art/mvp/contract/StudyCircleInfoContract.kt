 ...
 * ================================================
 */
interface StudyCircleInfoContract {
    //对于经常使用的关于UI的方法可以定义到IView中,如显示隐藏进度条,和显示文字消息
    interface View : IView {
        fun requestDelShareSuccess()
        fun requestShareCommentSuccess()
        fun requestShareDetailSuccess(data:ShareDetailBean?,isRefresh: Boolean?)
        fun requestShareDetailFail()
    }
    ...
    interface Model : IModel {
        ...
        fun shareComment(
            sessionId: String, shareId: String, comment: String
        ): Observable<BaseJson<Any>>
    }

...
constructor(repositoryManager: IRepositoryManager) : BaseModel(repositoryManager), MineContract.Model {
    ...
    override fun cancelAccount(sessionId: String): Observable<BaseJson<Any>> {
        return mRepositoryManager.obtainRetrofitService(CommonService::class.java).cancelAccount(sessionId)
    }

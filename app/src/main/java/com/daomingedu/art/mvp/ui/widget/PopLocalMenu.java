 ...
 */
public class PopLocalMenu extends PopupWindow implements CancelAdapt {


    Button pop_video, pop_recording;
    View v;

    public PopLocalMenu(Activity act, View.OnClickListener listener, boolean isShare) {
        super(act);
        AutoSize.cancelAdapt(act);
        LayoutInflater inflater = (LayoutInflater) act.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        v = inflater.inflate(R.layout.pop_local_menu, null);
